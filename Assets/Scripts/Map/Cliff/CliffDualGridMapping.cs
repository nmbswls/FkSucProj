...
namespace My.Map.Cliff
{
    ...
    {
        // row 0 比南缘格高 1，与 View 草缘对齐；向下叠 Height 行
        public static Vector3Int ResolveCliffCell(int viewX, int viewSouthEdgeY, int rowIndex, int z)
        {
            return new Vector3Int(viewX, viewSouthEdgeY + 1 - rowIndex, z);
        }
