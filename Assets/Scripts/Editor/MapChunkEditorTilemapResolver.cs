...
{
    const string DefaultLogicHeightConfigAssetPath = "Assets/Resources/MapLogicHeightConfig.asset";
    ...
    public static bool TryResolveTileGrounds(MapChunkEditorRoot editorRoot, out Tilemap[] tileGrounds)
    {
        ...
        var logicHeightConfig = LoadDefaultLogicHeightConfig();
        if (logicHeightConfig != null)
        {
            tileGrounds = WorldAreaRoot.CollectGroundTilemaps(grid, tileHole, logicHeightConfig);
    ...
    static MapLogicHeightConfig LoadDefaultLogicHeightConfig()
    {
        return AssetDatabase.LoadAssetAtPath<MapLogicHeightConfig>(DefaultLogicHeightConfigAssetPath);
    }
}
