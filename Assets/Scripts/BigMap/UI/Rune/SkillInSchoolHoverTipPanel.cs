...
{
    public sealed class SkillInSchoolHoverTipPanel : MonoBehaviour, IHoverTipPanel
    {
        ...
        public void OnHoverTipUpdate(HoverTipParams tipParams, IHoverInfoProvider provider)
        {
            ...
            if (provider is not SkillInSchoolHoverProvider skillHover)
            {
                return;
            }
        ...
        void RefreshContent(SkillInSchoolHoverProvider provider)
        {
