...
{
[System.Serializable]
public sealed partial class AlchemyAspectDef : Luban.BeanBase
{
    public AlchemyAspectDef(JSONNode _buf) 
    {
    ...
    public static AlchemyAspectDef DeserializeAlchemyAspectDef(JSONNode _buf)
    {
        return new demo.AlchemyAspectDef(_buf);
    }
    ...
    public const int __ID__ = 301349207;
