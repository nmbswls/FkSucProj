...
{
    public static EAbilityInterruptMask SourceToMask(InterruptSource s)
    {
        return s switch
        {
            InterruptSource.Hit => EAbilityInterruptMask.Hit,
            InterruptSource.Stun => EAbilityInterruptMask.Stun,
            InterruptSource.KnockUp => EAbilityInterruptMask.KnockUp,
            InterruptSource.InputCancel => EAbilityInterruptMask.InputCancel,
...
public class MapEntityAbilityController
{
    ...
    public LogicFightEffectContext GenerateEfffectContextByAbility()
    {
